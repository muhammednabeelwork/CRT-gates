  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 top-[20%] z-20 flex flex-col items-center justify-center text-center px-4">
        <h1 className="text-5xl font-bold uppercase tracking-[0.25em] text-[#96f1c9] mb-4">Self‑Sufficient Sanitation Infrastructure</h1>
        <p className="mt-2 max-w-2xl text-lg text-white/80">Rapid Sanitation During Emergencies</p>
        <button
          onClick={() => (window.location.href = BACK_URL)}
          className="mt-4 px-4 py-2 bg-[#066D55]/20 border border-[#066D55] rounded text-[#96f1c9]"
        >
          Back to Main
        </button>
      </div>
